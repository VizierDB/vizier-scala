...
/* this file is AUTOGENERATED by `scripts/build_routes` from `src/main/resources/vizier-routes.txt` */
...
trait VizierAPIServletRoutes extends HttpServlet {
  ...
  val ROUTE_PATTERN_39 = "/projects/([0-9]+)/branches/([0-9]+)/workflows/([0-9]+)/modules/([0-9]+)/charts/([0-9]+)".r
  val ROUTE_PATTERN_40 = "/projects/([0-9]+)/branches/([0-9]+)/head/modules/([0-9]+)/charts/([0-9]+)".r
  ...
  override def doGet(request: HttpServletRequest, response: HttpServletResponse) = 
  {
    ...
    processResponse(request, response) {
      request.getPathInfo match {
        ...
        case ROUTE_PATTERN_39(projectId, branchId, workflowId, modulePosition, artifactId) => GetArtifactHandler.Typed(ArtifactType.CHART).handle(Map("projectId" -> JsNumber(projectId.toLong), "branchId" -> JsNumber(branchId.toLong), "workflowId" -> JsNumber(workflowId.toLong), "modulePosition" -> JsNumber(modulePosition.toLong), "artifactId" -> JsNumber(artifactId.toLong)), connection)
        case ROUTE_PATTERN_40(projectId, branchId, modulePosition, artifactId) => GetArtifactHandler.Typed(ArtifactType.CHART).handle(Map("projectId" -> JsNumber(projectId.toLong), "branchId" -> JsNumber(branchId.toLong), "modulePosition" -> JsNumber(modulePosition.toLong), "artifactId" -> JsNumber(artifactId.toLong)), connection)
        ...
        case ROUTE_PATTERN_57(projectId, artifactId) => GetArtifactHandler.File.handle(Map("projectId" -> JsNumber(projectId.toLong), "artifactId" -> JsNumber(artifactId.toLong)), connection)
        case ROUTE_PATTERN_58(projectId, artifactId, tail) => GetArtifactHandler.File.handle(Map("projectId" -> JsNumber(projectId.toLong), "artifactId" -> JsNumber(artifactId.toLong), "tail" -> JsString(tail)), connection)
  ...
  override def doPost(request: HttpServletRequest, response: HttpServletResponse) = 
  {
    ...
    processResponse(request, response) {
      request.getPathInfo match {
        ...
        case ROUTE_PATTERN_41(projectId, branchId, workflowId, modulePosition) => FreezeModulesHandler.handle(Map("projectId" -> JsNumber(projectId.toLong), "branchId" -> JsNumber(branchId.toLong), "workflowId" -> JsNumber(workflowId.toLong), "modulePosition" -> JsNumber(modulePosition.toLong)), connection)
        case ROUTE_PATTERN_42(projectId, branchId, modulePosition) => FreezeModulesHandler.handle(Map("projectId" -> JsNumber(projectId.toLong), "branchId" -> JsNumber(branchId.toLong), "modulePosition" -> JsNumber(modulePosition.toLong)), connection)
        case ROUTE_PATTERN_43(projectId, branchId, workflowId, modulePosition) => FreezeModulesHandler.FreezeOne.handle(Map("projectId" -> JsNumber(projectId.toLong), "branchId" -> JsNumber(branchId.toLong), "workflowId" -> JsNumber(workflowId.toLong), "modulePosition" -> JsNumber(modulePosition.toLong)), connection)
        case ROUTE_PATTERN_44(projectId, branchId, modulePosition) => FreezeModulesHandler.FreezeOne.handle(Map("projectId" -> JsNumber(projectId.toLong), "branchId" -> JsNumber(branchId.toLong), "modulePosition" -> JsNumber(modulePosition.toLong)), connection)
  ...
  override def doOptions(request: HttpServletRequest, response: HttpServletResponse) = 
  {
    ...
    processResponse(request, response) {
      request.getPathInfo match {
        ...
        case ROUTE_PATTERN_39(projectId, branchId, workflowId, modulePosition, artifactId) => CORSPreflightResponse("GET")
        case ROUTE_PATTERN_40(projectId, branchId, modulePosition, artifactId) => CORSPreflightResponse("GET")
