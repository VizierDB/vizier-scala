...
object CommandList
{
  ...
  val DEFAULT: Seq[(String, Seq[SpecialCommand])] = Seq(
    ...
    "Visualize" -> Seq(
      ...
      SpecialCommand(label = "Scatterplot2.0",    icon = "scatter_plot", packageId = "plot", commandId = "scatterplot2", description = "Visualize datasets as a series of colored points"),
