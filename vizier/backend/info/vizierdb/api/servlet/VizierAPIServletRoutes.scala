  ...
  override def doGet(request: HttpServletRequest, response: HttpServletResponse) = 
  {
    ...
    processResponse(request, response) {
      request.getPathInfo match {
        ...
        case ROUTE_PATTERN_27(projectId, branchId, workflowId) => RawJsonResponse(Json.toJson(SuggestCommand(projectId = projectId.toLong, branchId = branchId.toLong, workflowId = workflowId.toLong, before = queryParameter(connection, "before").map { _.toLong }, after = queryParameter(connection, "after").map { _.toLong }):Seq[serialized.PackageDescription]))
        case ROUTE_PATTERN_28(projectId, branchId) => RawJsonResponse(Json.toJson(SuggestCommand(projectId = projectId.toLong, branchId = branchId.toLong, before = queryParameter(connection, "before").map { _.toLong }, after = queryParameter(connection, "after").map { _.toLong }):Seq[serialized.PackageDescription]))
        case ROUTE_PATTERN_29(projectId, branchId, workflowId, modulePosition) => RawJsonResponse(Json.toJson(GetModule(projectId = projectId.toLong, branchId = branchId.toLong, workflowId = workflowId.toLong, modulePosition = modulePosition.toInt):serialized.ModuleDescription))
        case ROUTE_PATTERN_30(projectId, branchId, modulePosition) => RawJsonResponse(Json.toJson(GetModule(projectId = projectId.toLong, branchId = branchId.toLong, modulePosition = modulePosition.toInt):serialized.ModuleDescription))
        ...
        case ROUTE_PATTERN_46(projectId, branchId, modulePosition, artifactId) => RawJsonResponse(Json.toJson(GetArtifact.typed(ArtifactType.CHART)(projectId = projectId.toLong, branchId = branchId.toLong, modulePosition = modulePosition.toInt, artifactId = artifactId.toInt):serialized.ArtifactDescription))
        case ROUTE_PATTERN_48(projectId, artifactId) => RawJsonResponse(Json.toJson(GetArtifact.Dataset(projectId = projectId.toLong, artifactId = artifactId.toLong, offset = queryParameter(connection, "offset").map { _.toLong }, limit = queryParameter(connection, "limit").map { _.toInt }, profile = queryParameter(connection, "profile")):serialized.DatasetDescription))
        case ROUTE_PATTERN_49(projectId, artifactId) => RawJsonResponse(Json.toJson(GetArtifact.Annotations(projectId = projectId.toLong, artifactId = artifactId.toLong, column = queryParameter(connection, "column").map { _.toInt }, row = queryParameter(connection, "row")):Seq[Caveat]))
        case ROUTE_PATTERN_50(projectId, artifactId) => RawJsonResponse(Json.toJson(GetArtifact.Summary(projectId = projectId.toLong, artifactId = artifactId.toLong):serialized.ArtifactSummary))
        case ROUTE_PATTERN_51(projectId, artifactId) => GetArtifact.CSV(projectId = projectId.toLong, artifactId = artifactId.toLong)
        case ROUTE_PATTERN_52(projectId, artifactId) => GetArtifact.File(projectId = projectId.toLong, artifactId = artifactId.toLong)
        case ROUTE_PATTERN_53(projectId, artifactId) => RawJsonResponse(Json.toJson(GetArtifact(projectId = projectId.toLong, artifactId = artifactId.toLong, offset = queryParameter(connection, "offset").map { _.toLong }, limit = queryParameter(connection, "limit").map { _.toInt }, profile = queryParameter(connection, "profile")):serialized.ArtifactDescription))
        case ROUTE_PATTERN_54(projectId, artifactId) => RawJsonResponse(Json.toJson(GetArtifact.Annotations(projectId = projectId.toLong, artifactId = artifactId.toLong, column = queryParameter(connection, "column").map { _.toInt }, row = queryParameter(connection, "row")):Seq[Caveat]))
        case ROUTE_PATTERN_55(projectId, artifactId) => RawJsonResponse(Json.toJson(GetArtifact.Summary(projectId = projectId.toLong, artifactId = artifactId.toLong):serialized.ArtifactSummary))
        case ROUTE_PATTERN_56(projectId, artifactId) => GetArtifact.CSV(projectId = projectId.toLong, artifactId = artifactId.toLong)
        case ROUTE_PATTERN_57(projectId, artifactId) => GetArtifact.File(projectId = projectId.toLong, artifactId = artifactId.toLong)
        case ROUTE_PATTERN_59(projectId, artifactId) => GetArtifact.File(projectId = projectId.toLong, artifactId = artifactId.toLong)
        case ROUTE_PATTERN_60(projectId, artifactId, tail) => GetArtifact.File(projectId = projectId.toLong, artifactId = artifactId.toLong, tail = tail)
        case ROUTE_PATTERN_61(artifactName) => RawJsonResponse(Json.toJson(GetPublishedArtifact(artifactName = artifactName):serialized.ArtifactDescription))
        case "/tasks" => RawJsonResponse(Json.toJson(ListTasks():Seq[serialized.WorkflowSummary]))
        case "/filesystem" => RawJsonResponse(Json.toJson(BrowseFilesystem():Seq[serialized.FilesystemObject]))
        case ROUTE_PATTERN_65(path) => RawJsonResponse(Json.toJson(BrowseFilesystem(path = path):Seq[serialized.FilesystemObject]))
  ...
  override def doPost(request: HttpServletRequest, response: HttpServletResponse) = 
  {
    ...
    processResponse(request, response) {
      request.getPathInfo match {
        ...
        case ROUTE_PATTERN_31(projectId, branchId, workflowId, modulePosition) => RawJsonResponse(Json.toJson(InsertModule(projectId = projectId.toLong, branchId = branchId.toLong, workflowId = workflowId.toLong, modulePosition = modulePosition.toInt, packageId = (jsonBody \ "packageId").as[String], commandId = (jsonBody \ "commandId").as[String], arguments = (jsonBody \ "arguments").as[serialized.CommandArgumentList.T]):serialized.WorkflowDescription))
        case ROUTE_PATTERN_32(projectId, branchId, modulePosition) => RawJsonResponse(Json.toJson(InsertModule(projectId = projectId.toLong, branchId = branchId.toLong, modulePosition = modulePosition.toInt, packageId = (jsonBody \ "packageId").as[String], commandId = (jsonBody \ "commandId").as[String], arguments = (jsonBody \ "arguments").as[serialized.CommandArgumentList.T]):serialized.WorkflowDescription))
        case ROUTE_PATTERN_37(projectId, branchId, workflowId, modulePosition) => RawJsonResponse(Json.toJson(ThawModules(thawUptoHere=true)(projectId = projectId.toLong, branchId = branchId.toLong, workflowId = workflowId.toLong, modulePosition = modulePosition.toInt):serialized.WorkflowDescription))
        case ROUTE_PATTERN_38(projectId, branchId, modulePosition) => RawJsonResponse(Json.toJson(ThawModules(thawUptoHere=true)(projectId = projectId.toLong, branchId = branchId.toLong, modulePosition = modulePosition.toInt):serialized.WorkflowDescription))
        case ROUTE_PATTERN_39(projectId, branchId, workflowId, modulePosition) => RawJsonResponse(Json.toJson(ThawModules(thawUptoHere=false)(projectId = projectId.toLong, branchId = branchId.toLong, workflowId = workflowId.toLong, modulePosition = modulePosition.toInt):serialized.WorkflowDescription))
        case ROUTE_PATTERN_40(projectId, branchId, modulePosition) => RawJsonResponse(Json.toJson(ThawModules(thawUptoHere=false)(projectId = projectId.toLong, branchId = branchId.toLong, modulePosition = modulePosition.toInt):serialized.WorkflowDescription))
        case ROUTE_PATTERN_41(projectId, branchId, workflowId, modulePosition) => RawJsonResponse(Json.toJson(FreezeModules(freezeFromHere=true)(projectId = projectId.toLong, branchId = branchId.toLong, workflowId = workflowId.toLong, modulePosition = modulePosition.toInt):serialized.WorkflowDescription))
        case ROUTE_PATTERN_42(projectId, branchId, modulePosition) => RawJsonResponse(Json.toJson(FreezeModules(freezeFromHere=true)(projectId = projectId.toLong, branchId = branchId.toLong, modulePosition = modulePosition.toInt):serialized.WorkflowDescription))
        case ROUTE_PATTERN_43(projectId, branchId, workflowId, modulePosition) => RawJsonResponse(Json.toJson(FreezeModules(freezeFromHere=false)(projectId = projectId.toLong, branchId = branchId.toLong, workflowId = workflowId.toLong, modulePosition = modulePosition.toInt):serialized.WorkflowDescription))
        case ROUTE_PATTERN_44(projectId, branchId, modulePosition) => RawJsonResponse(Json.toJson(FreezeModules(freezeFromHere=false)(projectId = projectId.toLong, branchId = branchId.toLong, modulePosition = modulePosition.toInt):serialized.WorkflowDescription))
        ...
        case ROUTE_PATTERN_58(projectId) => RawJsonResponse(Json.toJson(CreateFile(projectId = projectId.toLong, file = connection.getPart("file")):serialized.ArtifactSummary))
  ...
  override def doDelete(request: HttpServletRequest, response: HttpServletResponse) = 
  {
    ...
    processResponse(request, response) {
      request.getPathInfo match {
        ...
        case ROUTE_PATTERN_33(projectId, branchId, workflowId, modulePosition) => RawJsonResponse(Json.toJson(DeleteModule(projectId = projectId.toLong, branchId = branchId.toLong, workflowId = workflowId.toLong, modulePosition = modulePosition.toInt):serialized.WorkflowDescription))
        case ROUTE_PATTERN_34(projectId, branchId, modulePosition) => RawJsonResponse(Json.toJson(DeleteModule(projectId = projectId.toLong, branchId = branchId.toLong, modulePosition = modulePosition.toInt):serialized.WorkflowDescription))
        case _ => fourOhFour(request)
      }
    }
  }
